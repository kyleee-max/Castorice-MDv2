...
⏰ Waktu masih ada!`
            ...
            if (isBenar) {
                ...
                // Tampilkan kalimat lengkap
                const kalimatLengkap = sesi.soal.replace('_______', `*${sesi.jawaban}*`);
...
━━━━━━━━━━━━━━━━━━━━
💡 Isi bagian _______ dengan kata yang tepat!
...
💰 Hadiah: *${WIN_KOIN} Koin + ${XP_WIN} XP*`
            ...
            console.error('[LENGKAPIKALIMAT ERROR]', err.message);
