...
✨ +${XP_WIN} XP${levelUp ? `\n\n🎉 *LEVEL UP! → Lv.${newLevel}*` : ''}`,
                ...
                return m.reply(`❌ Salah! Coba pikir lebih kreatif... 😄`);
            }
        }

        // ── Mulai sesi baru ──
        try {
            m.reply('🎭 Sedang menyiapkan teka teki...');
...
💰 Hadiah: *${WIN_KOIN} Koin + ${XP_WIN} XP*`
            ...
            console.error('[TEKATEKI ERROR]', err.message);
