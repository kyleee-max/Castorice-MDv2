...
module.exports = {
    ...
    run: async (castorice, m, { prefix, command, args }) => {
        ...
        if (sessions[chatId]) {
            ...
            if (!jawaban) {
                return m.reply(
`🎮 *Tebak Game — Masih Aktif!*

Tebak nama game dari gambar yang sudah dikirim!
...
🖼️ Tebak nama game dari gambar di atas!
...
💰 Hadiah: *${WIN_KOIN} Koin + ${XP_WIN} XP*`
            ...
            console.error('[TEBAKGAME ERROR]', err.message);
